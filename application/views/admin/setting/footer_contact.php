                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form  action="/admin/admin/contact_add" id="fot_contact" method="post" enctype="multipart/form-data">
                                <div class="row">
                                  <div class="col-lg-12 text-center">
                                    <div class="form-group">
                                      <label>Contact Images</label>
                                        <img src="<?=base_url()?>webroot/admin/logo/Add-Photo-Button.png" id="upload_contact" onclick="get_upload_contact()" class="add_img_button">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="display" style="min-width: 854px">
                                ...
                                <tbody>
                                                                    <tr>
                                        <td>1</td>
                                        <td><div>info@nitsolution.in</div></td>
                                        <td><div >7896541230</div></td>
                                        <td><div class="all_seller_table_width">Copyright © 2020 Bongtech Solutions Private Limited | All Rights Reserved.</div></td>
                                        <td><div class="all_seller_table_width">15/1 Russa road Tollygunj
Near Prince Anwar sah Crossing</div></td>
                                        ...
                                        <td>
                                            <img src="/admin/webroot/admin/contact/7bff4b240f5b988a95f27fe074f7ad63_thumb.png" class="showTableImage" id="product_img">
                                        </td>
                                        <td>
                                            <input type="checkbox" class="js-switch" onchange="common_status_change(this.value)" id="status" value="CkNqmew93vZuRDzV0UMA2l1OTsQr76" checked /></td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="javascript:void(0)" class="btn btn-primary shadow btn-xs sharp mr-1" onclick="edit_action('CkNqmew93vZuRDzV0UMA2l1OTsQr76')" id="get_action_val_CkNqmew93vZuRDzV0UMA2l1OTsQr76"> <i class="fa fa-pencil"></i></a>
