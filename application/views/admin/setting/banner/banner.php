                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <div class="row">
                                  <div class="col-lg-12 text-center">
                                    <div class="form-group">
                                        <img src="<?=base_url()?>webroot/admin/logo/Add-Photo-Button.png" id="upload_banner" onclick="get_upload('banner_image')" class="add_img_button">
                                            <input type="file" class="image-upload select_image" name="image" class="validate[required]" id="banner_image" style="display: none" accept=".jpg,.jpeg,.png" onchange="show_photo(this,'banner_image','upload_banner')">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <button type="submit" class="btn btn-primary save_submit" style="margin-left: 756px;" onclick="checkfile('banner_image')"><strong>Save<strong></button>
                                </div>
                            </form>
                        </div>
                    </div>
