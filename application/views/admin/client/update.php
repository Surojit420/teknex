                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="<?=base_url()?>admin/client/client_update" id="client" method="post" enctype="multipart/form-data">
                                <div class="row">
                                        ...
                                        <div class="form-group"> 
                                         ...
                                         <input type="hidden" name="old_image" value="<?=$value->image?>">
                                           <img src="<?=base_url()?>webroot/admin/images/client/<?=$value->image?>" id="upload_client" onclick="get_upload('client_image')" class="add_img_button">
                                            <input type="file" class="image-upload select_image" name="image" class="validate[required]" id="client_image" style="display: none" accept=".jpg,.jpeg,.png" onchange="show_photo(this,'client_image','upload_client')" value="<?=$value->image?>">
